...
static void displayPinWrite( uint8_t pinName, int value )
{
    switch( display.connection ) {
        ...
        case DISPLAY_CONNECTION_GPIO_4BITS:
            switch( pinName ) {
                case DISPLAY_PIN_D4: HAL_GPIO_WritePin(D4_GPIO_Port, D4_Pin, (GPIO_PinState)value);   break;
                case DISPLAY_PIN_D5: HAL_GPIO_WritePin(D5_GPIO_Port, D5_Pin, (GPIO_PinState)value);   break;
                case DISPLAY_PIN_D6: HAL_GPIO_WritePin(D6_GPIO_Port, D6_Pin, (GPIO_PinState)value);   break;
                case DISPLAY_PIN_D7: HAL_GPIO_WritePin(D7_GPIO_Port, D7_Pin, (GPIO_PinState)value);   break;
                case DISPLAY_PIN_RS: HAL_GPIO_WritePin(D8_GPIO_Port, D8_Pin, (GPIO_PinState)value);   break;
                case DISPLAY_PIN_EN: HAL_GPIO_WritePin(D9_GPIO_Port, D9_Pin, (GPIO_PinState)value);   break;
                case DISPLAY_PIN_RW: break;
                default: break;
            }
            break;
